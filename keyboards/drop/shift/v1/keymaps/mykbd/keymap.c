...
// layer 0 win, layer 1 mac, layer 2 led and media
...
/**
 * @brief      Customize the RGB matrix for each layer
 * @details    This function is called every time the host requests a state update
